...
This repository represents my QA experience, such as manual testing, automation with Selenium, data-driven testing, documentation.  The projects are based on actual test processes: requirement analysis, test design, test execution, defect reporting and automation scripts.
